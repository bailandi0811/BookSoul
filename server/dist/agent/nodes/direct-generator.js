...
exports.createDirectGeneratorNode = void 0;
const PERSONAS = {
    assistant: {
        role: '专业的《天龙八部》小说助手',
        style: '用准确、详细的语言回答问题。',
...
请直接回答，不要加入多余的前置语。`;
const createDirectGeneratorNode = (model, getPersonaPrompt) => {
    return async (state) => {
...
exports.createDirectGeneratorNode = createDirectGeneratorNode;
//# sourceMappingURL=direct-generator.js.map